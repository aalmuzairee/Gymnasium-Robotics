...
from gymnasium_robotics.envs.fetch_kitchen.fetch_env import FetchRobot
...
class KitchenEnv(GoalEnv, EzPickle):
    ...
    The default control actuators in the Fetch MuJoCo model are joint position controllers. The input action is denormalize from `[-1,1]` to the actuator range and input
    ...
    * v0: legacy versions in the [D4RL](https://github.com/Farama-Foundation/D4RL).
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.robot_env = FetchRobot(
            model_path="../assets/fetch_kitchen/kitchen_assets/kitchen_env_model.xml",
            **kwargs,
        )
